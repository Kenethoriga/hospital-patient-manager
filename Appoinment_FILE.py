...
def book_appointment():
    ...
    main = Tk()
    main.title('APPOINTMENT MANAGEMENT')
    ...
    Label(main, text="Agakhan University Hospital Management System", font=headlabelfont, bg='SpringGreen').pack(side=TOP, fill=X)
    ...
    # Create scrollbars within the right_frame
    ...
    # Attach the scrollbars to the tree
    tree.configure(yscrollcommand=Y_scroller.set, xscrollcommand=X_scroller.set)
